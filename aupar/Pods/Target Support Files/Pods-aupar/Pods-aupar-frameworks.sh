...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MBSegueCollection/MBSegueCollection.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StyleDecorator/StyleDecorator.framework"
